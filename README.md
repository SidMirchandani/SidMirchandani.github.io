...
<body>
    ...
    <main>
        <section id="about" class="section">
            <div class="container">
                <h2>About Us</h2>
                <p>We are a global movement building innovative tech solutions to address critical social challenges. Join us in creating a sustainable future!</p>
            </div>
        </section>
        ...
        <section id="services" class="section">
            <div class="container">
                <h2>Our Services</h2>
                <p>From hackathons to global projects, we provide the tools, mentorship, and resources to make a real difference.</p>
            </div>
        </section>

        <section id="comp" class="section">
            <div class="container">
                <h2>Hack 4 Humanity 2024</h2>
                <p>You can compete today! We have $484K in prizes. Deadline is December 2, 2024 at 8:00pm EST.</p>
                <button><a href="https://hackhumanity.devpost.com/">Join us on Devpost!</a></button>
            </div>
        </section>
    </main>
    ...
    <footer>
        <div class="container">
            <p>&copy; This 501(c)(3) Organization was Fiscally Sponsored by Hack Club.</p>
        </div>
    </footer>
